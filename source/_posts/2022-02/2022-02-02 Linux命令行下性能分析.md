...
index_img: https://cdn.jsdelivr.net/gh/2017zhangyuxuan/picture_backend@master//hexo_img/linux2.jpeg
categories: 
- [计算机知识,linux]
tags:
- linux
...
![ubuntu中top命令截图](https://cdn.jsdelivr.net/gh/2017zhangyuxuan/picture_backend@master//img/202202041956057.png)
...
![程序优先级描述](https://cdn.jsdelivr.net/gh/2017zhangyuxuan/picture_backend@master//img/202202042034815.jpeg)
...
![按 f 键进入交互界面](https://cdn.jsdelivr.net/gh/2017zhangyuxuan/picture_backend@master//img/202202042053474.png)

- 先按`->`右键表示选中该列，在按上下移动键，就可以调整列的显示顺序

![调整列的顺序](https://cdn.jsdelivr.net/gh/2017zhangyuxuan/picture_backend@master//img/202202042056414.png)
...
![pstack打印函数调用栈](https://cdn.jsdelivr.net/gh/2017zhangyuxuan/picture_backend@master//img/202202042256078.png)
...
![程序中的系统调用](https://gitee.com/LoveAndShare/picture_backend/raw/master/img/202202151120052.png)
...
![安装perf命令](https://gitee.com/LoveAndShare/picture_backend/raw/master/img/202202151953426.png)

然后执行 `sudo perf top`命令，就可以看到 `perf`界面，如下图所示：

![perf top 界面](https://gitee.com/LoveAndShare/picture_backend/raw/master/img/202202152014700.png)

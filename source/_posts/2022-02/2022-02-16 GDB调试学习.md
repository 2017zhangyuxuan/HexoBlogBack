...
index_img: https://gitee.com/LoveAndShare/picture_backend/raw/master/img/202202161535550.jpeg
categories: 
- [计算机知识,linux]
tags: 
- GDB
...
![启动gdb](https://gitee.com/LoveAndShare/picture_backend/raw/master/img/202202160948610.png)
...
![list 查看源程序代码](https://gitee.com/LoveAndShare/picture_backend/raw/master/img/202202160951660.png)
...
![run 运行程序](https://gitee.com/LoveAndShare/picture_backend/raw/master/img/202202160953401.png)
...
![b 设置断点](https://gitee.com/LoveAndShare/picture_backend/raw/master/img/202202160957555.png)

## 5.单步执行

首先需要输入`run`启动程序，运行到第一个断点处，然后可以选择`step`单步调试（如果有函数调用则进入函数），`next`单步跟踪程序（遇到函数调用，直接调用函数，不会进入函数体内），`continue`继续运行到下一个断点处。

![执行程序](https://gitee.com/LoveAndShare/picture_backend/raw/master/img/202202161026973.png)
...
![查看变量](https://gitee.com/LoveAndShare/picture_backend/raw/master/img/202202161039792.png)
...
![退出gdb](https://gitee.com/LoveAndShare/picture_backend/raw/master/img/202202161041935.png)
...
![程序崩溃发生段错误](https://gitee.com/LoveAndShare/picture_backend/raw/master/img/202202161515053.png)
...
![调试core文件](https://gitee.com/LoveAndShare/picture_backend/raw/master/img/202202161511784.png)

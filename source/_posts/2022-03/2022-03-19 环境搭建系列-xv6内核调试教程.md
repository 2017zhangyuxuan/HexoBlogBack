...
index_img: https://gitee.com/LoveAndShare/picture_backend/raw/master/img/202203201204176.jpeg
categories: 
- [计算机知识,环境搭建系列]
- [计算机知识,操作系统]
tags: 
...
![报错信息1](https://gitee.com/LoveAndShare/picture_backend/raw/master/img/202203200908096.(null))

![报错信息2](https://gitee.com/LoveAndShare/picture_backend/raw/master/img/202203200908937.(null))
...
![查看磁盘分区使用情况](https://gitee.com/LoveAndShare/picture_backend/raw/master/img/202203192203252.(null))
...
![远程连接程序](https://gitee.com/LoveAndShare/picture_backend/raw/master/img/202203200909360.(null))

5. 然后把自己编译好的用户程序加载进来，也就是user目录下的文件` file user/_find`

![加载要调试的编译文件](https://gitee.com/LoveAndShare/picture_backend/raw/master/img/202203200909713.(null))

![设置断点并执行](https://gitee.com/LoveAndShare/picture_backend/raw/master/img/202203200909785.(null))

6. 然后设置好断点，就可以按下 c 让程序运行到断点处，再返回上个窗口，执行对应命令，就可以看到程序暂停住了，返回gdb调试程序窗口，也能看到当前暂停的地方就是刚刚设置的断点处。

![远程内核开始运行](https://gitee.com/LoveAndShare/picture_backend/raw/master/img/202203200909251.(null))

![gdb查看当前断点](https://gitee.com/LoveAndShare/picture_backend/raw/master/img/202203200910116.(null))
